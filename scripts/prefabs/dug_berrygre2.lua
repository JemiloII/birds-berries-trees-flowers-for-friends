...
local function make_plantable(data)
	...
	local function fn(Sim)
		...
		inst.components.inventoryitem.imagename = "greenberry2dug"	
    	inst.components.inventoryitem.atlasname = "images/inventoryimages/greenberry2dug.xml"
...
local plantables = 
{
	--{name="berryblue", bank = "berrybush", anim="idle_dead", minspace=2},
	{name="berrygre2", bank = "berrybush2", inspectoverride = "dug_berrybush", anim = "idle_dead", minspace=2},
