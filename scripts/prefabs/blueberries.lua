...
BERRY = 
{
	...
	berrybl = MakeVegStats(0,	6,	2,	TUNING.PERISH_FAST, 0,
								10,	3,	TUNING.PERISH_SUPERFAST, 0),
--[[
...
local function MakeBerry(name, has_seeds)
	...
	local assets_cooked=
	{
		Asset("ANIM", "anim/berries.zip"),
		Asset("ANIM", "anim/"..name..".zip"),
		Asset("ATLAS", "images/inventoryimages/blueberry_cook.xml"),	
    	Asset("IMAGE", "images/inventoryimages/blueberry_cook.tex")
	}
	...
	local function fn()
		...
		inst:AddComponent("inspectable")
		inst:AddComponent("inventoryitem")
		if name == "berrybl" then
			inst.components.inventoryitem.imagename = "blueberry"	
	...
	local function fn_cooked()
		...
		inst:AddComponent("inspectable")
		inst:AddComponent("inventoryitem")
		inst.components.inventoryitem.imagename = "blueberry_cook"	
    	inst.components.inventoryitem.atlasname = "images/inventoryimages/blueberry_cook.xml"
...
return MakeBerry("berrybl", false)
