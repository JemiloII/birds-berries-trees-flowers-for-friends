...
local function make_plantable(data)
	...
	local function fn(Sim)
		...
		inst.components.inventoryitem.imagename = "blueberry2dug"	
    	inst.components.inventoryitem.atlasname = "images/inventoryimages/blueberry2dug.xml"
...
local plantables = 
{
	...
	{name="berryblu2", bank = "berrybush2", inspectoverride = "dug_berrybush", anim = "idle_dead", minspace=2},
