...
local function make_plantable(data)
	...
	local function fn(Sim)
		...
		inst.components.inventoryitem.imagename = "greenberrydug"	
    	inst.components.inventoryitem.atlasname = "images/inventoryimages/greenberrydug.xml"
...
local plantables = 
{
	{name="berrygree", bank = "berrybush", anim="idle_dead", minspace=2},
