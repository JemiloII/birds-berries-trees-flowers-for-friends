...
local function OnPreLoad(inst, data)
    -- Preserved for backwards compatibility with old saves
...
local function normal_postinit(inst)
    inst.components.pickable:SetUp("berrygr", TUNING.BERRY_REGROW_TIME)
...
return createbush("berrygre2", "berrygre2", "berrygr", normal_postinit)
