...
local function make_plantable(data)
	...
	local function fn(Sim)
		...
		inst.components.inventoryitem.imagename = "pineappledug"	
    	inst.components.inventoryitem.atlasname = "images/inventoryimages/pineappledug.xml"
...
local plantables = 
{
	{name="pineapple", bank = "berrybush", anim="idle_dead", minspace=2},
