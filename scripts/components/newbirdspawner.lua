...
local BIRD_TYPES =
{
    ...
    --[GROUND.ROAD] = {"robye", "sickv"},
		[GROUND.ROCKY] = {"robye", "robgr", "sickv"},
		[GROUND.DIRT] = {"robye", "bluer", "robgr", "sickv"},
		[GROUND.SAVANNA] = {"robye", "robgr", "tucan"},
		[GROUND.GRASS] = { "robgr", "robye", "ntpie"},
		[GROUND.FOREST] = {"robye", "robgr", "ntpie"},
		[GROUND.MARSH] = {"robye", "robgr", "ntpie"},
        [GROUND.DESERT_DIRT] = {"tucan", "robye", "sickv"},
        [GROUND.DECIDUOUS] = {"tucan", "bluer", "ntpie"},
...
local function PickBird(spawnpoint)
    ...
    return _worldstate.iswinter and bird == "bluer" and "bluer" or bird
end
